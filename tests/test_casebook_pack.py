"""Regression checks for the tidal-algo-set-mark casebook."""
...
from casebook.harness import assert_expected, tidal_algo_set_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tidal_algo_set_mark_summary(), assert_expected())
